...
public class PhoneAppDial extends JPanel {
    ...
    private class Dial extends JPanel {
        private static final long serialVersionUID = 1L;
        JButton one = createButton("1"), two = createButton("2"), three = createButton("3"), four = createButton("4"),
                five = createButton("5"), six = createButton("6"), seven = createButton("7"), eight = createButton("8"),
                nine = createButton("9"), star = createButton("*"), zero = createButton("0"), hash = createButton("#");
        ...
        public void paintComponent(Graphics g) {
            ...
            numberField.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(240, 240, 240, 80)));
            backspace.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(240, 240, 240, 80)));
        }
    ...
    class CallAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (phoneNum.length() != 0) {
                new WidgetCall(phoneNum, getLocationOnScreen());
            }
            numberField.setText("");
        }
    }
...
// class CallSuggestion extends JPanel {
// private static final long serialVersionUID = 1L;

// AppDefault tmp = new AppDefault();
// JTextField searchContacts;

// CallSuggestion() {
// searchContacts = new JTextField("Search Contacts");
// searchContacts.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0,
// Color.lightGray));
// searchContacts.setBounds(3, 3, (int) (tmp.panelWidth * 0.8), 35);

// searchContacts.setForeground(Color.GRAY);
// searchContacts.addFocusListener(new FocusListener() {
// @Override
// public void focusGained(FocusEvent e) {
// if (searchContacts.getText().equals("Search Contacts")) {
// searchContacts.setText("");
// searchContacts.setForeground(Color.BLACK);
// }
// }

// @Override
// public void focusLost(FocusEvent e) {
// if (searchContacts.getText().isEmpty()) {
// searchContacts.setForeground(Color.GRAY);
// searchContacts.setText("Search Contacts");
// }
// }
// });
// }

// public void pullUpSuggestions(String input, String inputType) {
// if (inputType == "byName") {

// } else if (inputType == "byNumber") {
