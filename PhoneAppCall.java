...
public class PhoneAppCall extends JPanel {
    ...
    Icon muteDef = tmp.getIcon("mute"), muteSel = tmp.getIcon("mute-selected"),
         keypadDef = tmp.getIcon("dial"),
         speakerDef = tmp.getIcon("speaker"), speakerSel = tmp.getIcon("speaker-selected"),
         addCallDef = tmp.getIcon("add-call"),
         holdDef = tmp.getIcon("hold"),
         endCallIcon = tmp.getIcon("end-call");
    JButton mute = createCallAction("mute", muteDef, muteSel), 
            keypad = createCallAction("dial", keypadDef, keypadDef), 
    ...
    class ActivateAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if(toggleIcon) putValue(Action.SMALL_ICON, selectedIcon);
            else putValue(Action.SMALL_ICON, defaultIcon);
        }
    }
