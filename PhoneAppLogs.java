...
public class PhoneAppLogs extends JPanel {
    ...
    int widgetHeight = 80;
    JPanel w1 = new WidgetCallCard("Francisca", "+233 26 222 1123", "Today", null);
    ...
    JPanel w4 = new WidgetCallCard("Madam Gifty", "+233 26 222 1123", "Today", null);
    JPanel w5 = new WidgetCallCard("L3trician", "+233 57 122 2333", "Today", null);
    JPanel w6 = new WidgetCallCard("Jumia", "+233 24 333 4445", "Today", null);
    JPanel w7 = new WidgetCallCard("Danielle", "+233 57 122 2333", "Today", null);
    ...
    public void paintComponent(Graphics g) {
        ...
        setPreferredSize(new Dimension(tmp.panelWidth, 20 + ((widgetHeight + 7) * 8)));
    }
}