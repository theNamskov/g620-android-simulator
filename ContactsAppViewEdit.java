...
public class ContactsAppViewEdit extends JPanel {
    ...
    JButton saveButton = new JButton("commit", tmp.getIcon("save-sm"));
    JButton editButton = new JButton("edit", tmp.getIcon("edit-sm"));
    ...
    public ContactsAppViewEdit(String phoneNumber) {
        ...
        // firstNameField.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0,
        // Color.LIGHT_GRAY));
        ...
        // lastNameField.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0,
        // Color.LIGHT_GRAY));
        ...
        // numberField.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0,
        // Color.LIGHT_GRAY));
        ...
        editButton.setBounds(w - 100, h - 50, 80, 40);
