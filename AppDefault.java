...
public class AppDefault extends JPanel {
    ...
    public int panelWidth = (int) (0.92 * img.getWidth(null)), panelHeight = (int) (0.895 * img.getHeight(null)),
            ...
            navPaneH = panelHeight - navPaneY, contentPaneH = panelHeight - navPaneH;
    private JPanel navigationPane = new JPanel();
    JButton backButton, homeButton;
    private int backButtonPosX = (int) (panelWidth * .08), homeButtonPosX = (int) (panelWidth * .46);
    ...
    public void paintComponent(Graphics g) {
        ...
        homeButton.addActionListener(event -> homeAction(new HomeScreen()));
    ...
    public void homeAction(JPanel app) {
